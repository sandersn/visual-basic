...
Begin VB.Form frmMusicHdr 
   ...
   Begin TabDlg.SSTab tabCDLib 
      ...
      TabPicture(0)   =   "MusicHdr.frx":0442
      ...
      TabCaption(1)   =   "Notes"
      TabPicture(1)   =   "MusicHdr.frx":045E
      Tab(1).ControlCount=   0
      Tab(1).ControlEnabled=   0   'False
      TabCaption(2)   =   "Categories"
      TabPicture(2)   =   "MusicHdr.frx":047A
...
Private Sub datMusicHdr_Reposition()
    ...
    Else
        If datMusicHdr.Recordset("Rating").Value > 2 Then
            optRating(2).Value = True
            Exit Sub
        End If
